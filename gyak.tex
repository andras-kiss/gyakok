...
\subsection
A gyakorlat során, az Aspirin hidrolízisének kinetikailag elsõrendõ reakciójának hõmérsékletfüggését vizsgáljuk.
A sebességi állandója a következõképpen adható meg:
k=1/tln(z/(z-x))
ahol t az idõ, z a reagens (jelen esetben a Aspirin) kezdeti koncentrációja, x pedig az elbomlott reagens koncentrációja.
